...
abstract class AppRoutes {
      ...
      routes: [
        ...
        ShellRoute(
          ...
          routes: [
            ...
            animatedRoute(path: kHomeView, child: const HomeView()),
            animatedRoute(path: kProfileView, child: const ProfileView()),
            animatedRoute(path: kBudgetView, child: BudgetView()),
            animatedRoute(path: kWalletView, child: const WalletView()),
            animatedRoute(path: kNotificationView, child: NotificationView()),
            animatedRoute(
              path: kReportsView,
  ...
  static GoRoute animatedRoute({required String path, required Widget child}) {
    return GoRoute(
      path: path,
      pageBuilder:
